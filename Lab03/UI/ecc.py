...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(60, 150, 111, 16))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(60, 270, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.txt_infor.setGeometry(QtCore.QRect(190, 150, 321, 81))
        self.txt_infor.setObjectName("txt_infor")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(190, 280, 321, 81))
        self.txt_sign.setObjectName("txt_sign")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(144, 440, 91, 31))
        font = QtGui.QFont()
        ...
        self.btn_verify.setGeometry(QtCore.QRect(410, 440, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.btn_gen.setGeometry(QtCore.QRect(410, 70, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "ECCC Cipher"))
